...
public class ExemplosCriteria {
	...
	public void resultadoConstrutores() {
		...
		Root<Carro> carro = criteriaQuery.from(Carro.class);// pegando todos so carros
	...
	public void caixaAlta() {
		// exemplo de funcao dentro do builder
		CriteriaBuilder builder = manager.getCriteriaBuilder();
...
//ordernacao no criteria
	...
	@Test
	public void carroComValoresAcimaDaMedia() {
		CriteriaBuilder builder = manager.getCriteriaBuilder();
		CriteriaQuery<Carro> criteriaQuery = builder.createQuery(Carro.class);
